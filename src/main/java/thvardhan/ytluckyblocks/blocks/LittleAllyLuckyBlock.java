...
public class LittleAllyLuckyBlock extends Block {
	...
	private void drops(World worldIn,BlockPos pos,EntityPlayer player){
		...
		switch(rand.nextInt(51)){
			...
			case 19:
			{
				ExtraFunctions.summonMobsNearby(new EntityAlexirCraft(worldIn), 30, worldIn, pos, rand);break;
			}
			case 20:
			{
			...
			case 46:
			{
                ExtraFunctions.summonMobsNearby(new EntityLittleAlly(worldIn), 50, worldIn, pos, rand);break;
			}
			case 47:
			{
