	...
	private void drops(World worldIn,BlockPos pos,EntityPlayer player){
		...
		switch(rand.nextInt(101)){
			...
			case 55:{
				...
				ExtraFunctions.summonMobsNearby(new EntityJeromeASF(worldIn), 25, worldIn, pos, rand);break;
			}case 64:{
				...
				ExtraFunctions.summonMobsNearby(new EntityCreeper(worldIn), 15, worldIn, pos, rand);break;
			}case 75:{
