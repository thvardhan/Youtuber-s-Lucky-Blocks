...
public class PetaZahHuttLuckyBlock extends Block {
	...
	private void drops(World worldIn,BlockPos pos,EntityPlayer player){
		...
		switch(rand.nextInt(51)){
			...
			case 10:
			{
				ExtraFunctions.summonMobsNearby(new EntityPeteZahHutt(worldIn), 15, worldIn, pos, rand);break;
			}
			case 11:
			{
				ExtraFunctions.summonMobsNearby(new EntityIronGolem(worldIn), 5, worldIn, pos, rand);	break;
			}
			case 12:
			{
			...
			case 15:
			{
				ExtraFunctions.summonMobsNearby(new EntityCreeper(worldIn), 111, worldIn, pos, rand);break;
			}
			case 16:
			{
