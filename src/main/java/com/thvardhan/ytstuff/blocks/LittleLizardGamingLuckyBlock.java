	...
	private void drops(World worldIn,BlockPos pos,EntityPlayer player){
		...
		switch(rand.nextInt(51)){
			...
			case 19:{
				...
				ExtraFunctions.summonMobsNearby(new EntityIronGolem(worldIn), 35, worldIn, pos, rand);break;
			}case 29:{
			...
			case 48:
			{
				ExtraFunctions.summonMobsNearby(new EntityAlexirCraft(worldIn), 50, worldIn, pos, rand);break;
			}
			case 49:
			{
