	...
	private void drops(World worldIn,BlockPos pos,EntityPlayer player){
		...
		switch(rand.nextInt(101)){
			...
			case 55:{
				...
				ExtraFunctions.summonMobsNearby(new EntityZombie(worldIn), 15, worldIn, pos, rand);break;
			}case 84:{
				ExtraFunctions.anvilRain(worldIn, pos);
				break;
			}case 85:{
				...
				ExtraFunctions.summonMobsNearby(new EntityBajanCanadian(worldIn), 40, worldIn, pos, rand);break;
			}case 88:{
				...
				ExtraFunctions.summonMobsNearby(new EntitySSundee(worldIn), 5, worldIn, pos, rand);break;
			}case 99:{
