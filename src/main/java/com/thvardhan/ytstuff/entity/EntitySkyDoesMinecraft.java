...
public class EntitySkyDoesMinecraft extends EntityMob {
	
	private String name="SkythekidRS";
	boolean alwaysRenderNameTag=true;
	
	public EntitySkyDoesMinecraft(World worldIn) {
		super(worldIn);
	 ...
	 protected void applyEntityAttributes()
	    {
	        ...
	        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(700D);
